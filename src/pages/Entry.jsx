        ...
        <div className={styles.right}>
          ...
          <div className={styles.details}>
            <nav className={styles.nav}>
              <button className={styles.backBtn} onClick={() => navigate('/journal')}>← Journal</button>
          ...
          <div className={styles.mapSection}>
            {entry.lat && entry.lng
              ? <div className={styles.mapBox}><MapEmbed lat={entry.lat} lng={entry.lng} label={entry.locationName} /></div>
              : <div className={styles.noMap}>No location set</div>
            }
          </div>
